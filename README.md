...
**Status Aktif (17 September 2026):** Pengujian operasional kontinu 7 hari penuh telah **berhasil dituntaskan** menggunakan firmware v4.0.0 build `a945ea070fcc` (10–17 September 2026). Total akumulasi mencapai **170,535 jam operasional** dengan **30.260 rekaman telemetri cloud** (ThingSpeak Channel 3480764). Secara kumulatif 7 hari (5 sesi booting), kelengkapan slot tercatat **98,59%** (30.260 feed dari 30.692 slot), tingkat keberhasilan percobaan pengiriman **98,90%** (30.259 sukses dari 30.596 percobaan; 337 kegagalan jaringan, 101 slot dilewati saat Wi-Fi belum siap), dan kestabilan heap RAM teramati pada 196–201 KB (deviasi standar 100,64 bytes). Sesi kontinu terpanjang berjalan selama **151,26 jam non-stop (27.022 sampel, Boot `f27413f0`)** dengan deviasi standar heap 86,41 bytes, kelengkapan slot 99,25%, dan keberhasilan kirim 99,57%. Empat transisi restart tercatat (3 kali kode reset 1 / power-on, 1 kali kode 7 / watchdog timer) dengan jeda 22–51 detik, di mana penyebab fisik restart tidak dipastikan secara spekulatif tanpa instrumentasi daya independen. Draf naskah ilmiah telah disusun pada [Draf Jurnal](MD/draf_jurnal_metode_dan_hasil_stuzha.md) dan laporan audit 7 hari pada [Laporan 7 Hari](MD/laporan_pengambilan_data_7hari.md). Keberhasilan deployment operasional tidak menggantikan kalibrasi laboratorium resmi.
...
Pengujian 7 hari mencatat 30.260 rekaman telemetri dengan sesi kontinu terpanjang 151,26 jam non-stop (Boot `f27413f0`). Dataset lengkap tersimpan secara otomatis di cloud ThingSpeak Channel 3480764. Statistik lengkap dan riwayat sesi berada pada [data](Program/data/dataset_stuzha.md).
